 ...
 */
final class Version20230102193438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mark (id INT NOT NULL, student_id_id INT NOT NULL, subject_id INT DEFAULT NULL, value NUMERIC(10, 0) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(50) NOT NULL, surname VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
